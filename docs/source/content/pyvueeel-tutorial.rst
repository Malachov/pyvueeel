...
It's recommended way to download ``project-starter`` where all the files for gui are already edited and ready to use.
...
If you want to build just what is necessary from scratch, you can use this tutorial.
